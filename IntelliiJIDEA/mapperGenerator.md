# mapper   dao  entity代码生成器

##resource下新建generator/generatorConfig.xml。配置相应数据库连接、数据库驱动包、要生成的库表等。
...
<generatorConfiguration>
    ...
    <context id="Mysql" targetRuntime="MyBatis3Simple" defaultModelType="flat">
        ...
        <jdbcConnection driverClass="com.mysql.jdbc.Driver"
                        connectionURL="jdbc:mysql://192.168.15.55:3306/email"
                        userId="root"
                        password="123456">
        </jdbcConnection>
        <!-- 生成模型的包名和位置 -->
        ...
        <!-- 要生成的那些表 -->
        <table tableName="email_info" domainObjectName="EmailInfoEntity">
        </table>
    </context>
</generatorConfiguration>
```

## 点击maven project中mybatis-generator:generate，自动生成mapper entity  dao等。